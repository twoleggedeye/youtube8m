...
if __name__ == "__main__":
  ...
  flags.DEFINE_boolean("frame_features", False, "Use frame level features")
...
def build_graph(reader,
  ...
  Args:
    ...
    model: The core model (e.g. logistic or neural net). It should inherit
           from BaseModel.
    eval_data_path: glob path to the evaluation data files.
...
def evaluate():
  ...
  with tf.Graph().as_default():
    ...
    if FLAGS.eval_data_path is "":
      raise IOError("'eval_data_path' was not specified. " +
                     "Nothing to evaluate.")
